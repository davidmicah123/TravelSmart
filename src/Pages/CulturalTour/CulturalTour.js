...
// import classes from "./CulturalTour.module.css";
...
//     const filteredData = CulturalData.filter(destination => 
...
import CulturalData from '../../Data/CulturalData';
import DashboardFooter from '../../Components/DashboardFooter/DashboardFooter';
import DestinationModal from '../../Components/DestinationModal/DestinationModal'; // Import the modal component
...
function CulturalTour() {
    ...
    const openModal = (destinationProps) => {
        setSelectedDestination(destinationProps);
        setIsModalOpen(true);
    };
    ...
    // Filter the data based on both selected continent and search term
    const filteredData = CulturalData.filter((destination) => {
